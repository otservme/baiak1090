...
ze_zombieMaxSpawn = 40 -- Max zombies in the arena
...
ze_maxPlayers = 20 -- Maxnimum players that can join
...
-- Waiting room
ze_WaitingRoomStartPosition = Position(5081, 4814, 7) -- Where should player be teleport in waiting room
ze_waitingRoomCenterPosition = Position(5081, 4817, 7) -- Center of the waiting room
ze_waitingRoomRadiusX = 2 -- Depends how big the arena room is 25sqm to x
ze_waitingRoomRadiusY = 2 -- Depends how big the arena room is 25sqm to y
 
-- Zombie arena
ze_zombieArenaStartPosition = Position(5078, 4742, 7) -- When even start where should player be teleported in the zombie arena?
ze_arenaCenterPosition = Position(5078, 4747, 7) -- Center position of the arena
ze_arenaFromPosition = Position(5049, 4722, 7) -- Pos of top left corner
ze_arenaToPosition = Position(5106, 4772, 7) -- Pos of bottom right corner
ze_arenaRoomRadiusX = 40 -- Depends how big the arena room is 50sqm to x
ze_arenaRoomRadiusY = 40 -- Depends how big the arena room is 50sqm to y
ze_arenaRoomMultifloor = false -- Does the arena have more floors than one?
 
-- Other variables
ze_waitTime = 10 -- How long until the event begin?
ze_createTeleportPosition = Position(5044, 5022, 7) -- Where should the teleport be created?
